    ...
    <div className="space-y-10">
      ...
      <div className="space-y-4 p-5 rounded-2xl border border-border bg-card shadow-xs">
        ...
        {allTechnologies.length > 0 && (
          <div className="flex flex-wrap items-center gap-1.5 pt-2 border-t border-border/60">
            <span className="text-xs font-medium text-muted-foreground mr-1">{t('project.filterByTech')}</span>
            <button
              type="button"
      ...
      {paginatedProjects.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center rounded-2xl border border-border bg-card p-8 shadow-xs">
          ...
          <h3 className="text-lg font-semibold text-foreground mb-1">{t('project.noProjectsFound')}</h3>
          ...
          <button
            type="button"
            onClick={handleClearFilters}
            className="mt-5 px-4 py-2 text-xs font-medium rounded-xl border border-border bg-muted/60 hover:bg-muted text-foreground transition-colors cursor-pointer"
          >
            {t('common.clearFilters')}
          </button>
        </div>
