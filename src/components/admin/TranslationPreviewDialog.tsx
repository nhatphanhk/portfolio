              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative hidden sm:block">
                  ...
                  <input
                    ...
                    className="w-36 lg:w-44 pl-7 pr-2 py-1 text-xs rounded-lg border border-border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                  {searchQuery && (
                    <button
                      type="button"
