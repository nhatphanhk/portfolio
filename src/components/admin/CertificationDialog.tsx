      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form id="cert-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-2">
          <div>
            ...
            <input {...register('name')} placeholder="AWS Solutions Architect" className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground shadow-xs text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input {...register('issuer')} placeholder="Amazon Web Services" className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground shadow-xs text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="date" {...register('issueDate')} className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground shadow-xs text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
              {errors.issueDate && <p className="text-xs text-destructive mt-1">{errors.issueDate.message}</p>}
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Expiry Date</label>
              <input type="date" {...register('expiryDate')} className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground shadow-xs text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input {...register('credentialId')} placeholder="ABC123" className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground shadow-xs text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Verify URL</label>
              <input {...register('credentialUrl')} placeholder="https://..." className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground shadow-xs text-sm focus:outline-none focus:ring-2 focus:ring-ring" />
          ...
          <div>
            ...
            <textarea {...register('description')} rows={3} placeholder="Brief description of the certification..." className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground shadow-xs text-sm focus:outline-none focus:ring-2 focus:ring-ring resize-none" />
          </div>
        </form>
